...
<p class="has-x-large-font-size"><?php esc_html_e('Contact . Contact . Contact . Contact . Contact . Contact . Contact .','tt5-fse'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<h4 class="wp-block-heading has-primary-color has-text-color has-link-color"><?php esc_html_e('Get in touch with us today and let\'s bring your vision to life!','tt5-fse'); ?></h4>
<!-- /wp:heading -->
...
<p class="has-x-small-font-size"><?php esc_html_e('Contact us now to discuss your project and discover how we can create an extraordinary online experience together.','tt5-fse'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<p><?php esc_html_e('© Copyright 2025.','tt5-fse'); ?></p>
<!-- /wp:paragraph -->
...
echo sprintf( esc_html__( 'Proudly Powered by %1$sWordPress%2$s', 'tt5-fse' ), '<a href="' . esc_url( 'https://wordpress.org' ) . '" rel="nofollow">', '</a>' ); ?> <?php esc_html_e('','tt5-fse'); ?>Designed by Community.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->